"""
URL configuration for rodriguez_diego_FINAL project.
...
from rodriguez_diegoAPP_FINAL import views

urlpatterns = [
    path('', views.index),
    path('autor/', views.autor),
    path('agregarInstituciones/', views.agregarInstituciones),
    path('listarInstituciones/', views.listarInstituciones),
    path('agregarSeminarios/', views.agregarSeminarios),
    path('listarSeminarios/', views.listarSeminarios),
